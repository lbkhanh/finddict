package finddict.googlecloudviion.example.com.finddict;
    ...
    private String convertResponseToString(BatchAnnotateImagesResponse response) {
        ...
        if (faces != null) {
            for (FaceAnnotation face : faces) {
                message.append(String.format(Locale.getDefault(), "%.3f: %s",
                        face.getDetectionConfidence(), face.getSorrowLikelihood()));
                message.append("\n");
                message.append(String.format(Locale.getDefault(), "%.3f: %s",
                        face.getDetectionConfidence(), face.getHeadwearLikelihood()));
                message.append("\n");
                message.append(String.format(Locale.getDefault(), "%.3f: %s",
                        face.getDetectionConfidence(), face.getDetectionConfidence()));
                message.append("\n");
                message.append(String.format(Locale.getDefault(), "%.3f: %s",
                        face.getDetectionConfidence(), face.getAngerLikelihood()));
                message.append("\n");
                message.append(String.format(Locale.getDefault(), "%.3f: %s",
                        face.getDetectionConfidence(), face.getBlurredLikelihood()));
                message.append("\n");
                message.append(String.format(Locale.getDefault(), "%.3f: %s",
                        face.getDetectionConfidence(), face.getBoundingPoly()));
                message.append("\n");
                message.append(String.format(Locale.getDefault(), "%.3f: %s",
                        face.getDetectionConfidence(), face.getFdBoundingPoly()));
                message.append("\n");
                message.append(String.format(Locale.getDefault(), "%.3f: %s",
                        face.getDetectionConfidence(), face.getLandmarkingConfidence()));
                message.append("\n");
                message.append(String.format(Locale.getDefault(), "%.3f: %s",
                        face.getDetectionConfidence(), face.getLandmarks()));
                message.append("\n");
                message.append(String.format(Locale.getDefault(), "%.3f: %s",
                        face.getDetectionConfidence(), face.getPanAngle()));
                message.append("\n");
                message.append(String.format(Locale.getDefault(), "%.3f: %s",
                        face.getDetectionConfidence(), face.getSurpriseLikelihood()));
                message.append("\n");
                message.append(String.format(Locale.getDefault(), "%.3f: %s",
                        face.getDetectionConfidence(), face.getJoyLikelihood()));
                message.append("\n");
                message.append(String.format(Locale.getDefault(), "%.3f: %s",
                        face.getDetectionConfidence(), face.getUnderExposedLikelihood()));
                message.append("\n");
                message.append(String.format(Locale.getDefault(), "%.3f: %s",
                        face.getDetectionConfidence(), face.getTiltAngle()));
                message.append("\n");
                message.append(String.format(Locale.getDefault(), "%.3f: %s",
                        face.getDetectionConfidence(), face.getRollAngle()));
                message.append("\n");
            }
        } else {
            message.append("nothing\n");
